...
#include "custom_msgs/srv/change_formation.hpp"
...
namespace Neighborhood {
    ...
    private:
        /**
         * @brief Converts vectors representing x, y, and z coordinates to Eigen Vector3d objects and updates formation member.
    ...
    private:
        ...
        // Service server for runtime formation changes
        rclcpp::Service<custom_msgs::srv::ChangeFormation>::SharedPtr change_formation_service_;
    };
